...
/* Generated from: osm_pbf.proto */

#ifndef PROTOBUF_C_osm_5fpbf_2eproto__INCLUDED
#define PROTOBUF_C_osm_5fpbf_2eproto__INCLUDED
...
typedef enum {
  OSMPBF__BLOB__DATA__NOT_SET = 0,
  OSMPBF__BLOB__DATA_RAW = 1,
  OSMPBF__BLOB__DATA_ZLIB_DATA = 3,
  OSMPBF__BLOB__DATA_LZMA_DATA = 4,
  OSMPBF__BLOB__DATA_OBSOLETE_BZIP2_DATA = 5,
  OSMPBF__BLOB__DATA_LZ4_DATA = 6,
  OSMPBF__BLOB__DATA_ZSTD_DATA = 7
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(OSMPBF__BLOB__DATA__CASE)
} OSMPBF__Blob__DataCase;

/*
 * A file contains a sequence of fileblock headers, each prefixed by
...
struct  OSMPBF__Blob
{
  ...
  int32_t raw_size;
  OSMPBF__Blob__DataCase data_case;
  union {
    /*
...
#endif  /* PROTOBUF_C_osm_5fpbf_2eproto__INCLUDED */
